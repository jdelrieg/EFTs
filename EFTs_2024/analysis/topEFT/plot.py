...
parser.add_argument('--lumiJson', '-l', default = '/nfs/fanae/user/jriego/TFGs/EFTs_2024/topcoffea/json/lumi.json' , help = 'Lumi json file')
#parser.add_argument('--path',     '-p', default = '/nfs/fanae/user/jriego/TFGs/EFTs_2024/new_tfg/pruebattH.pkl.gz'      , help = 'Path to pkl file')
parser.add_argument('--variable', '-v', default = 'ht'                         , help = 'Variable')
...
path  = '/nfs/fanae/user/jriego/TFGs/EFTs_2024/new_tfg/'#pruebattH.pkl.gz'#, 'histos/MC.pkl.gz']#args.path
...
processDic = {
  'ttH': 'ttHJet_privateUL18', 
  'ttlv': 'ttlnuJet_privateUL18', 
}
bkglist = ['ttlv', 'ttH']
