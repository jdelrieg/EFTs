...
class AnalysisProcessor(processor.ProcessorABC):
    ...
    def __init__(self, samples, wc_names_lst=[], hist_lst=None, ecut_threshold=None, do_errors=False, do_systematics=False, split_by_lepton_flavor=False, skip_signal_regions=False, skip_control_regions=False, muonSyst='nominal', dtype=np.float32):
       ...
       # "ptz"     : HistEFT("Events", wc_names_lst, hist.Cat("sample", "sample"), hist.Cat("channel", "channel"), hist.Cat("systematic", "Systematic Uncertainty"),hist.Cat("appl", "AR/SR"), hist.Bin("ptz",     "$p_{T}$ Z (GeV)", 40, 0, 1000)),
        ...
        "l1eta"   : HistEFT("Events", wc_names_lst, hist.Cat("sample", "sample"), hist.Cat("channel", "channel"), hist.Cat("systematic", "Systematic Uncertainty"),hist.Cat("appl", "AR/SR"), hist.Bin("l1eta",   "¿second? Leading lep $\eta$", 30, -3.0, 3.0)),
        "l0phi"   : HistEFT("Events", wc_names_lst, hist.Cat("sample", "sample"), hist.Cat("channel", "channel"), hist.Cat("systematic", "Systematic Uncertainty"),hist.Cat("appl", "AR/SR"), hist.Bin("l0phi",   "Leading lep $\phi$", 30, -10, 10)),
        "l1phi"   : HistEFT("Events", wc_names_lst, hist.Cat("sample", "sample"), hist.Cat("channel", "channel"), hist.Cat("systematic", "Systematic Uncertainty"),hist.Cat("appl", "AR/SR"), hist.Bin("l1phi",   "Leading lep $\phi$", 30, -10, 10)),
        
        "deltaetalep"   : HistEFT("Events", wc_names_lst, hist.Cat("sample", "sample"), hist.Cat("channel", "channel"), hist.Cat("systematic", "Systematic Uncertainty"),hist.Cat("appl", "AR/SR"), hist.Bin("deltaetalep",   "$\Delta\eta_{lep}$ " , 10, -1, 3.0)),
        "deltaphilep"   : HistEFT("Events", wc_names_lst, hist.Cat("sample", "sample"), hist.Cat("channel", "channel"), hist.Cat("systematic", "Systematic Uncertainty"),hist.Cat("appl", "AR/SR"), hist.Bin("deltaphilep",   "$\Delta\phi_{lep}$ ", 10, -1, 10)),
        "Rlep"   : HistEFT("Events", wc_names_lst, hist.Cat("sample", "sample"), hist.Cat("channel", "channel"), hist.Cat("systematic", "Systematic Uncertainty"),hist.Cat("appl", "AR/SR"), hist.Bin("Rlep",   "$\Delta R_{lep}$ ", 10, -1, 10)),
        
        "deltaphilj"   : HistEFT("Events", wc_names_lst, hist.Cat("sample", "sample"), hist.Cat("channel", "channel"), hist.Cat("systematic", "Systematic Uncertainty"),hist.Cat("appl", "AR/SR"), hist.Bin("deltaphilj",   "$\Delta\phi_{l j}$ ", 15, -1, 10)),
        #"deltaphilj_rebin"   : HistEFT("Events", wc_names_lst, hist.Cat("sample", "sample"), hist.Cat("channel", "channel"), hist.Cat("systematic", "Systematic Uncertainty"),hist.Cat("appl", "AR/SR"), hist.Bin("deltaphilj_rebin",   "$\Delta\phi_{l j}$ ", 10, -1, 10)),
        "deltaetalj"   : HistEFT("Events", wc_names_lst, hist.Cat("sample", "sample"), hist.Cat("channel", "channel"), hist.Cat("systematic", "Systematic Uncertainty"),hist.Cat("appl", "AR/SR"), hist.Bin("deltaetalj",   "$\Delta\eta_{l j}$ " , 10, -1, 3.0)),
        "Rlj"   : HistEFT("Events", wc_names_lst, hist.Cat("sample", "sample"), hist.Cat("channel", "channel"), hist.Cat("systematic", "Systematic Uncertainty"),hist.Cat("appl", "AR/SR"), hist.Bin("Rlj",   "$\Delta R_{lj}$ ", 20, -1, 10)),
        "Rlj_rebin"   : HistEFT("Events", wc_names_lst, hist.Cat("sample", "sample"), hist.Cat("channel", "channel"), hist.Cat("systematic", "Systematic Uncertainty"),hist.Cat("appl", "AR/SR"), hist.Bin("Rlj_rebin",   "$\Delta R_{lj}$ ", 10, -1, 10)),				
        ...
        "ht"      : HistEFT("Events", wc_names_lst, hist.Cat("sample", "sample"), hist.Cat("channel", "channel"), hist.Cat("systematic", "Systematic Uncertainty"),hist.Cat("appl", "AR/SR"), hist.Bin("ht",      "H$_{T}$ (GeV)", 30, 0, 1250)),
        "ht_rebin"      : HistEFT("Events", wc_names_lst, hist.Cat("sample", "sample"), hist.Cat("channel", "channel"), hist.Cat("systematic", "Systematic Uncertainty"),hist.Cat("appl", "AR/SR"), hist.Bin("ht_rebin",      "H$_{T}$ (GeV)", 12, 0, 1250)),
    ...
    def process(self, events):
        ...
        wgt_correction_syst_lst = [
            "lepSF_muonUp","lepSF_muonDown","lepSF_elecUp","lepSF_elecDown",f"btagSFbc_{year}Up",f"btagSFbc_{year}Down",f"btagSFlight_{year}Up",f"btagSFlight_{year}Down","triggerSFUp","triggerSFDown",#"PUUp","PUDown","PreFiringUp","PreFiringDown", # Exp systs
            #"lepSF_muonUp","lepSF_muonDown","lepSF_elecUp","lepSF_elecDown",f"btagSFbc_{year}Up",f"btagSFbc_{year}Down","btagSFbc_corrUp","btagSFbc_corrDown",f"btagSFlight_{year}Up",f"btagSFlight_{year}Down","btagSFlight_corrUp","btagSFlight_corrDown","triggerSFUp","triggerSFDown",#"PUUp","PUDown","PreFiringUp","PreFiringDown", # Exp systs
        ...
        for syst_var in syst_var_list:
           ...
           # varnames["ljptsum"] = ljptsum
            ...
            varnames["l1eta"]  = l1.eta
            varnames["l0phi"]=l0.phi
            varnames["l1phi"]=l1.phi  #variables definidas por mi en primera prueba
            varnames["deltaetalj"]=np.abs(l0.eta-ak.flatten(j0.eta))
            varnames["deltaphilj"]=np.abs(l0.phi-ak.flatten(j0.phi))
            varnames["Rlj"]=np.sqrt((np.abs(l0.eta-ak.flatten(j0.eta)))**2+(np.abs(l0.phi-ak.flatten(j0.phi)))**2)  #variables angulares entre lepton y jet mas energeticos
            
           
            varnames["Rlj_rebin"]=np.sqrt((np.abs(l0.eta-ak.flatten(j0.eta)))**2+(np.abs(l0.phi-ak.flatten(j0.phi)))**2)
          
          
          
            varnames["deltaetalep"]= abs(l0.eta-l1.eta)
            varnames["deltaphilep"]=abs(l0.phi-l1.phi)
            varnames["Rlep"]=np.sqrt((np.abs(l0.phi-l1.phi))**2+(np.abs(l0.eta-l1.eta))**2)         #Variables angulares entre los dos leptones mas energeticos
                            ...
                            for appl in cat_dict[nlep_cat][njet_val]["appl_lst"]:
                                ...
                                for lep_chan in cat_dict[nlep_cat][njet_val]["lep_chan_lst"]:
                                    ...
                                    for lep_flav in cat_dict[nlep_cat][njet_val]["lep_flav_lst"]:
                                        ...
                                        if (("deltaetalj" in dense_axis_name) & (("CRZ" in ch_name) or ("CRflip" in ch_name))): continue
                                        if (("deltaphilj" in dense_axis_name) & (("CRZ" in ch_name) or ("CRflip" in ch_name))): continue
                                        if (("Rlj" in dense_axis_name) & (("CRZ" in ch_name) or ("CRflip" in ch_name))): continue

                                        if (("deltaetalj" in dense_axis_name) & ("0j" in ch_name)): continue
                                        if (("deltaphilj" in dense_axis_name) & ("0j" in ch_name)): continue
                                        if (("Rlj" in dense_axis_name) & ("0j" in ch_name)): continue   
